namespace LackingPlatforms
{
    ...
    internal class LevelSaver
    {
        public static XmlDocument PrepareNewLevelDocument(string errormsg, string filename)
        {
            ...
            writer.Close();
            doc.Load(filename);
            doc.DocumentElement.InnerXml = "<Settings><BackgroundTexture>SkyA</BackgroundTexture><Gravity>1</Gravity><AirResistance>0.1</AirResistance></Settings><Entities></Entities><Static>28#21-f~14#12-a~14#15-f~15#11-a~15#15-b~15#16-f~16#6-f~16#10-A~16#15-a~16#15-b~16#16-f~17#10-a~17#15-b~17#16-f~18#10-a~18#15-b~18#16-f~19#10-a~19#15-b~19#16-f~20#10-a~20#15-b~20#16-f~21#6-f~21#10-a~21#15-b~21#16-f~22#11-a~22#15-b~22#16-f~23#12-a~23#15-" + errormsg + "~22#12</Static>";
            doc.Save(filename);
            doc.Load(filename);
            return doc;
        }
